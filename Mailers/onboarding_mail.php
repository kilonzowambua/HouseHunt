...
while ($mailer = $res->fetch_object()) {
  $mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Subject = 'Welcome To CBEF Portal';
    /* Custom Mail Body */
    $mail->Body = '
...
<table id="u_content_heading_2" style="font-family:Open Sans,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-line-height v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Rubik,sans-serif; font-size: 30px; font-weight: 400;"><strong>Welcome to House Hunt - Lets Begin Your Journey!</strong></h1>
...
<table style="font-family:Open Sans,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Lobster Two,cursive; font-size: 25px; font-weight: 700;">Dear '.$user_name .',</h1>
...
<table id="u_content_text_4" style="font-family:Open Sans,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height v-font-size" style="font-size: 14px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">At House Hunt, we understand that finding the perfect home is a significant milestone, and we are here to support you every step of the way. Our user-friendly platform, vast database of listings, and powerful search tools will make your house hunting journey smooth, efficient, and enjoyable.</p>
  </div>
...
<div align="center">
    ...
    <a href="#" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;font-family:Open Sans,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #1f5299; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:45%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
